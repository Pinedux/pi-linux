...
apply_gnome_rice() {
    ...
    case "$rice" in
        ...
        nordic)
            ...
            gnome_set_theme "Nordic" "Papyrus" "Bibata-Modern-Ice"
            ;;
...
apply_plasma_rice() {
    ...
    sudo -u "${PI_REAL_USER}" kwriteconfig5 --file kcmfonts --group General --key cursorTheme "Bibata-Modern-Ice" 2>/dev/null || true
